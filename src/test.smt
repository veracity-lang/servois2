...
(define-fun oper () Bool (and 
  ...
  (pop_list_impl_pre_condition err_r0 x0_r0 x1_r0 x2_r0 size_r0 list_memory_r0)
  (pop_list_impl_post_condition err_r0 x0_r0 x1_r0 x2_r0 size_r0 list_memory_r0 err_r1 x0_r1 x1_r1 x2_r1 size_r1 list_memory_r1 result_0_r1)
...
(define-fun bowtie () Bool (and
   (states_equal err_l1 x0_l1 x1_l1 x2_l1 size_l1 list_memory_l1 err_r1 x0_r1 x1_r1 x2_r1 size_r1 list_memory_r1)
))

(assert (not (=> (and oper (ite (= size_l0 0) (= list_memory_r0 nil) (ite (= size_l0 1) (and (= x0_l0 (head list_memory_r0)) (= (tail list_memory_r0) nil)) (ite (= size_l0 2) (and (= x1_l0 (head list_memory_r0)) (= x0_l0 (head (tail list_memory_r0))) (= (tail (tail list_memory_r0)) nil)) (and (= x2_l0 (head list_memory_r0)) (= x1_l0 (head (tail list_memory_r0))) (= x0_l0 (head (tail (tail list_memory_r0)))) (= (tail (tail (tail list_memory_r0))) nil)))))) bowtie)))
(check-sat)
(get-model)
